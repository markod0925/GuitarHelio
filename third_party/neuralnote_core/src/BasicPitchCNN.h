...
{
public:
    explicit BasicPitchCNN(const std::string& modelDir);
...
private:
    ...
    std::array<std::array<float, NUM_FREQ_OUT>, mNumNoteStored> mNotesCircularBuffer {};
    std::array<std::array<float, 32 * NUM_FREQ_OUT>, mNumConcat2Stored> mConcat2CircularBuffer {};
